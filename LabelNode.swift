...
//  ArkitMeasurement
//
//  Created by Abhijith on 19/05/20.
...
class LabelNode: SCNNode {
    ...
    ///   - colour: UIColor
    init(text: String, depth: CGFloat = 1, font: String = "Georgia", textSize: CGFloat = 0.1, colour: UIColor) {
    ...
    /// Places The LabelNode Between Two SCNNodes
    ///
    /// - Parameters:
    ///   - nodeA: SCNode
    ///   - nodeB: SCNode
